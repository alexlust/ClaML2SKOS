...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        xmlns:icd="http://icd.org/icd10gm2012syst_claml_20110923#" version="1.0">
        
        <xsl:variable name="code_temp" select="10"/>
        <xsl:template match="/">
                <rdf:RDF xml:icd="http://icd.org/icd10gm2012syst_claml_20110923#" >
                        <xsl:for-each select="/ClaML/Modifier">
                                <skos:Concept>
                                       <xsl:attribute name="rdf:about">
                                        ...
                                        <xsl:for-each select="Rubric/Label/Para">
                                                <skos:note>
